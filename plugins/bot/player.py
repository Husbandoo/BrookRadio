...
async def not_chat(_, m: Message):
    ...
    k=await m.reply_photo(photo="https://telegra.ph/file/4e839766d45935998e9c6.jpg", caption="**Sorry, You Can't Use This Bot In This Group! 🤷‍♂ But You Can Make Your Own Bot Like This From The [Source Code](https://t.me/NexusXSupport/12582) Below !**", reply_markup=InlineKeyboardMarkup(buttons))
    await mp.delete(m)
